                    ...
                    <div className="space-y-1.5 text-xs text-slate-600">
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={labor.CM_Status === 'Active' ? 'text-green-600' : 'text-red-600'}>
                            {labor.CM_Status || "—"}
                          </span>
                          {labor.CM_Delete_Type && (
                            <span className="text-slate-400 italic">({labor.CM_Delete_Type})</span>
                          )}
                        </div>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div className="hidden sm:grid sm:grid-cols-9 gap-2 md:gap-4 items-center">
                    ...
                    <div className="inline-flex items-center">
                      <div className="flex flex-col">
                        <span
                          className={`px-2 py-0.5 text-[10px] font-bold uppercase rounded-full w-fit ${labor.CM_Status === "Active"
                            ? "bg-green-100 text-green-700 border border-green-200"
                            : "bg-red-100 text-red-700 border border-red-200"
                            }`}
                        >
                          {labor.CM_Status || "Active"}
                        </span>
                        {labor.CM_Delete_Type && (
                          <span className="text-[10px] text-slate-500 font-medium mt-1 ml-1 truncate max-w-[80px]" title={labor.CM_Delete_Type}>
                            {labor.CM_Delete_Type}
                          </span>
                        )}
                      </div>
