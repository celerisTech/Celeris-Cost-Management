  ...
  const renderCard = (card, index) => {
    ...
    return (
      <button
        ...
        className={`
          relative flex flex-col rounded-xl border-l-4 bg-white/95 backdrop-blur-sm 
          p-1 sm:p-2 shadow-sm transition-all duration-300 hover:shadow-md
          h-28 sm:h-28 w-full sm:w-64 ${colors.border}
      ...
      >
        ...
        <div className="transform group-hover:scale-[1.02] transition-transform duration-300">
          <div className="flex items-start justify-between mb-2 sm:mb-3">
            ...
            <div className={`p-1 rounded-lg bg-white/80 shadow-xs ${colors.text} flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
              {card.icon}
            </div>
          </div>
