...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 p-3 sm:p-4 md:p-3 space-y-4 max-w-full bg-white overflow-y-auto min-h-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div className="w-full sm:flex-1 min-w-0">
          {isLoading ? (
            ...
            <h1 className="text-lg sm:text-xl md:text-2xl lg:text-2xl font-semibold flex flex-wrap items-center gap-2 leading-tight">
      ...
      {/* Stats */}
      <div className="w-full -mx-3 sm:mx-0 px-2 sm:px-0 overflow-hidden">
        <StatsCards />
      </div>

      {/* --- Tabs Section --- */}
      <div className="p-2 sm:p-2 flex justify-center items-center space-x-3 sm:space-x-6 transition-all duration-300">
        <button
        ...
        >
          ...
          <span>Projects</span>
          {activeTab === "projects" && (
            <span className="absolute bottom-0 left-0 right-0 h-[3px] bg-gray-300 rounded-full translate-y-1" />
          )}
        </button>
