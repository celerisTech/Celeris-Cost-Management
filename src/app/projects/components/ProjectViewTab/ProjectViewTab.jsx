...
export default function ProjectViewTab({
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  <h1 className="text-xl sm:text-lg lg:text-xl font-bold text-gray-900 truncate">
                ...
                <div className="relative inline-block text-left">
                  <div>
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-gray-600 text-white rounded-lg shadow-md hover:bg-gray-700 hover:to-blue-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
      ...
      {/* Project Statistics Summary - Single Row Design */}
      <div className="mb-2 sm:mb-3">
        <div className="max-w-auto mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            {/* Progress Section */}
            <div className="flex items-center gap-3 flex-1 min-w-[200px]">
              <h2 className="text-base sm:text-lg font-semibold text-gray-800 flex items-center whitespace-nowrap">
                <svg className="w-4 h-4 sm:w-4 sm:h-4 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
                Progress
              </h2>
              <div className="flex-1 min-w-[120px]">
                <div className="w-full h-1.5 sm:h-2 rounded-full overflow-hidden shadow-inner">
                  <div
                    className="h-full rounded-full bg-gray-200 transition-all duration-1000 ease-out"
                    style={{ width: `${projectProgress}%` }}
                  ></div>
                </div>
              </div>
              <span className="text-blue-700 font-bold text-xs sm:text-xs whitespace-nowrap">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-nowrap gap-2 sm:gap-3 w-full sm:w-auto">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 px-3 sm:px-4 py-2 rounded-lg text-center border border-yellow-200 shadow-sm hover:shadow-md transition-all">
                <div className="text-xs text-gray-600 font-medium">In Progress</div>
                <div className="text-base sm:text-lg font-bold text-yellow-600">{projectStats.inProgress}</div>
              </div>

              <div className="bg-gradient-to-br from-red-50 to-red-100 px-3 sm:px-4 py-2 rounded-lg text-center border border-red-200 shadow-sm hover:shadow-md transition-all">
                <div className="text-xs text-gray-600 font-medium">Delayed</div>
                <div className="text-base sm:text-lg font-bold text-red-600">{projectStats.delayedTasks}</div>
              </div>

              <div className="bg-gradient-to-br from-gray-50 to-gray-100 px-3 sm:px-4 py-2 rounded-lg text-center border border-gray-200 shadow-sm hover:shadow-md transition-all">
                <div className="text-xs text-gray-600 font-medium">Total</div>
                <div className="text-base sm:text-lg font-bold text-gray-700">{projectStats.total}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm sticky top-0 z-10 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex space-x-1 sm:space-x-2 overflow-x-auto scrollbar-hide">
            {[
              { id: 'details', name: 'Details', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
              { id: 'estimates', name: 'Estimates', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
              { id: 'milestones', name: 'Milestones', icon: 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z' },
              { id: 'tasks', name: 'Tasks', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
            ].map((tab) => (
              <button
                key={tab.id}
                onClick={() => {
                ...
                className={`
            group relative py-2.5 px-3 sm:px-5 rounded-lg font-medium text-sm 
          ...
          `}
              >
                {/* Icon */}
                <svg className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-200 ${activeSection === tab.id ? 'scale-110' : 'group-hover:scale-105'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Active Indicator */}
                {activeSection === tab.id && (
                  <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-500 rounded-full transform origin-left transition-all duration-200"></div>
                )}
              </button>
            ))}
          </div>
      ...
      {/* Content Area */}
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-4 lg:py-4">
        {error && (
