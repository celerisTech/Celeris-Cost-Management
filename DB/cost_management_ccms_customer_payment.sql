...
CREATE TABLE `ccms_customer_payment` (
  ...
  CONSTRAINT `fk_customer_payment_company` FOREIGN KEY (`CM_Company_ID`) REFERENCES `ccms_projects` (`CM_Company_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_customer_payment_project` FOREIGN KEY (`CM_Project_ID`) REFERENCES `ccms_projects` (`CM_Project_ID`) ON DELETE CASCADE ON UPDATE CASCADE
