...
BEGIN
    ...
    IF NEW.CM_Attendance_ID IS NULL OR NEW.CM_Attendance_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Attendance_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Category_ID IS NULL OR NEW.CM_Category_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Category_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Company_ID IS NULL OR NEW.CM_Company_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Company_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Customer_ID IS NULL OR NEW.CM_Customer_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Customer_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Godown_ID IS NULL OR NEW.CM_Godown_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Godown_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Brand_ID IS NULL OR NEW.CM_Brand_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Brand_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Budget_ID IS NULL OR NEW.CM_Budget_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Budget_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Payment_ID IS NULL OR NEW.CM_Payment_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Payment_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Consumption_ID IS NULL OR NEW.CM_Consumption_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Consumption_ID, 5) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Expense_ID IS NULL OR NEW.CM_Expense_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Expense_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Batch_ID IS NULL OR NEW.CM_Batch_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Batch_ID, 6) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Transfer_ID IS NULL OR NEW.CM_Transfer_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Transfer_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Item_ID IS NULL OR NEW.CM_Item_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Item_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Labor_Type_ID IS NULL OR NEW.CM_Labor_Type_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Labor_Type_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Milestone_ID IS NULL OR NEW.CM_Milestone_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Milestone_ID, 5) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Nav_Link_ID IS NULL OR NEW.CM_Nav_Link_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Nav_Link_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Reply_ID IS NULL OR NEW.CM_Reply_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Reply_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Notification_ID IS NULL OR NEW.CM_Notification_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Notification_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_ID IS NULL OR NEW.CM_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Request_ID IS NULL OR NEW.CM_Request_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Request_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Transaction_ID IS NULL OR NEW.CM_Transaction_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Transaction_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Update_ID IS NULL OR NEW.CM_Update_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Update_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Project_ID IS NULL OR NEW.CM_Project_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Project_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Product_ID IS NULL OR NEW.CM_Product_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Product_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Role_ID IS NULL OR NEW.CM_Role_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Role_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Subcategory_ID IS NULL OR NEW.CM_Subcategory_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Subcategory_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Supplier_ID IS NULL OR NEW.CM_Supplier_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Supplier_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Task_ID IS NULL OR NEW.CM_Task_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Task_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Unit_ID IS NULL OR NEW.CM_Unit_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Unit_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_User_ID IS NULL OR NEW.CM_User_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_User_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Transport_ID IS NULL OR NEW.CM_Transport_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Transport_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Service_ID IS NULL OR NEW.CM_Service_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Service_ID, 4) AS UNSIGNED)), 0)
...
BEGIN
    ...
    IF NEW.CM_Incentive_ID IS NULL OR NEW.CM_Incentive_ID = '' THEN
        SELECT IFNULL(MAX(CAST(SUBSTRING(CM_Incentive_ID, 4) AS UNSIGNED)), 0)
